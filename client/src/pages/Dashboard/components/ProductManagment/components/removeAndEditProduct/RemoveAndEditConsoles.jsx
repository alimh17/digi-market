...
const RemoveAndEditConsoles = () => {
  const [open, setOpen] = useState(false);
  const [openEdit, setOpenEdit] = useState(false);
  const [selectPorduct, setSelectProduct] = useState({});

  const { data, isLoading, isError } = useQuery("all_consoles", getAllConsole);
...
export default RemoveAndEditConsoles;
